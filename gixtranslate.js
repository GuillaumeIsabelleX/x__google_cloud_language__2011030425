...
require('yargs')
  ...
  .command(
    'tm <toLang> <model> <text..>',
    'Translates one or more strings into the target language using the specified model.',
    {},
    async opts =>
      await translateTextWithModelSample(opts.text, opts.toLang, opts.model)
  )
  .example('gixtranslate detect "Hello world!"', 'Detects the language of a string.')
  .example('gixtranslate d "Hello world!"', 'Detects the language of a string.')
  .example(
    'gixtranslate detect "Hello world!" "Goodbye"',
  ...
  .example(
    'gixtranslate list es',
    'Lists available translation languages with names in Spanish.'
  )
  .example(
    'gixtranslate t ru "Good morning!"',
    'Translates a string into Russian.'
  )
  .example(
    'gixtranslate translate ru "Good morning!"',
    'Translates a string into Russian.'
  )
  .example(
    'gixtranslate translate ru "Good morning!" "Good night!"',
    'Translates multiple strings into Russian.'
  )
  .example(
    'gixtranslate tm ru nmt "Good morning!" "Good night!"',
    'Translates multiple strings into Russian using the Premium model.'
  )
  .example(
    'gixtranslate translate-with-model ru nmt "Good morning!" "Good night!"',
    'Translates multiple strings into Russian using the Premium model.'
  )
  .wrap(120)
  .recommendCommands()
